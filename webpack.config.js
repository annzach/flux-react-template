module.exports ={
  ...
  //test: a reg exp which defines how the file looks like /\.js$ 
   ...
   //devServer rules are added for React Router to work.
   //inline in devServer prevents the webpack dev server thing to be in the url .(React Router does it for us).
   //historyApiFallback ... It always gives the url of the right page
   //port: setiing default port to 8000.
   debug:true,
   devServer:{
    progress : true,
    inline:true,
